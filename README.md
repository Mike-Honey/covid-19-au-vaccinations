...
Case data for many infectious diseases are gathered from the [NNDSS](https://www.health.gov.au/our-work/nndss) via this [GitHUb project](https://github.com/amacali/nindss-data), run by [Anthony Macali AM](https://x.com/migga), which has been collecting daily snapshots since late 2023.  Prior to 2024, I use the annual totals from that dataset, apart from a selection of diseases where I blend in monthly totals: COVID-19, Influenza, Measles and RSV.
